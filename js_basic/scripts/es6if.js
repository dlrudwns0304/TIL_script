...
let x = 5;
let y = x+10;
// 삼항조건의 참 거짓 결과가 console.log에 출력되는 형태
...
reBtn.addEventListener('click', ()=> {
    console.log(re.value) // 콘솔테스트 : 리뷰내용 출력
    console.log(re.value.length) // 콘솔테스트 : 리뷰글자수 출력
    result = re.value.length >= 100 ? '등록완료' : '100자 이상입력하세요';
    alert(result)
})
// 쇼핑 수량과 가격 알고리즘
// 1개 가격 기준 12500원
...
// 감소 버튼 클릭 시 현재 수량이 1보다 작으면 '최소구매수량입니다' 아니면 수량 감소
