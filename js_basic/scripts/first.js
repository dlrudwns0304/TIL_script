...
bow1 = '콩';
//console.log(bow1); //콩
// 자바스크립트는 절차적 언어이기 때문에 css처럼 우선순위에 따라 최종결과값만 인식하는것이 아닌 실행 함수의 작성 위치에 따라 다른 변수값을 인식 할 수 있다.
var a = 1;
var b = 5; 
var c = 10;
 //문자 b가 아닌 변수 b를 a에 대입한다 변수를 대입한다==변수값을 대입한다.
c = a;
...
console.log('=========데이터공부')
var b;
console.log(typeof d); //값이 할당되지 않는 상태 undefined(오류찾기용)
d = a;
...
console.log(box2 + ' ' +box3 +'는 ' + typeof(box2+box3)+'입니다!'); //hello javascript는 string 입니다
